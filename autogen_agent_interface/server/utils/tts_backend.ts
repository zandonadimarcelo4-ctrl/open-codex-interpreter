...
async def generate():
    try:
        ...
        jarvis = JarvisVoiceSystem(
            language="pt-BR",
            voice_speed=0.88,  # Mais lento para soar mais grave e masculino
        ...
        if jarvis.tts_engine == "elevenlabs":
            ...
            data = {
                ...
                "voice_settings": {
                    "stability": 0.85,  # Alta estabilidade = voz mais consistente, grave e masculina
                    "similarity_boost": 0.95,  # Muito alta similaridade para manter timbre original masculino
                    "style": 0.0,  # Estilo neutro para voz mais natural e masculina
                    "use_speaker_boost": False  # Desabilitar para evitar afinação artificial
                },
