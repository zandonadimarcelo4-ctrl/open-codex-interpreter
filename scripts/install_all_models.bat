@echo off
REM Script para instalar TODOS os modelos recomendados para orquestração inteligente
REM Brain: Qwen2.5-32B-MoE (atual) + Qwen3-30B-A3B-Instruct-2507 (experimental)
REM Executor: DeepSeek-Coder-V2-Lite (código geral) + UIGEN-T1-Qwen-14 (UI especializado)
...
REM 1. Instalar Brain: Qwen2.5-32B-MoE (atual, recomendado)
echo ========================================
...
ollama pull qwen2.5-32b-instruct-moe-rtx
if %ERRORLEVEL% NEQ 0 (
...
REM 2. Instalar Brain: Qwen3-30B-A3B-Instruct-2507 (experimental)
echo ========================================
...
REM 3. Instalar Executor: DeepSeek-Coder-V2-Lite (código geral)
echo ========================================
...
REM 4. Instalar Executor: UIGEN-T1-Qwen-14 (UI especializado)
echo ========================================
